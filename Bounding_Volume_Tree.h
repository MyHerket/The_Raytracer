...
bvh_node::bvh_node(
	const std::vector<shared_ptr<hitable>>& src_objects, size_t start, size_t end, double time0, double time1) {
...
//Falta agregar cuando los objetos no tienen una caja envolvente posible.
