...
int main()
{
    ...
    Sample_Scene.loadMesh("cubo", "cow.obj", pink);


    Sample_Scene.render("Something", "image2.ppm", 600, 200, point3(26, 3, 6), point3(0, 2, 0), vec3(0, 1, 0), 20.0, color(0.1, 0.1, 0.1), Lights);
